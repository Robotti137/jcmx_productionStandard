<template>
  <div class="container">
    ...
    <div class="center li-he border-b">
      ...
      <span :class="order.productionType === '特殊要求：根据地形做护栏' ? 'marqueed' : 'marquee'">特殊要求：根据地形做护栏</span>
    </div>
      ...
      <div class="flex" style="flex:1;">
        ...
        <div style="width:50%;max-width:50%;height:100%;">
          <p>
            ...
            >外墙写实表现</span>
            <span :class="order.buildingProduction.facade.type === '镜面' ? 'marqueed' : 'marquee'">镜面</span>
            <span
              :class="order.buildingProduction.facade.type === '幕墙玻璃' ? 'marqueed' : 'marquee'"
            >幕墙玻璃</span>
            <span :class="order.buildingProduction.facade.type === '木质' ? 'marqueed' : 'marquee'">木质</span>
            <span :class="order.buildingProduction.facade.type === '水钻' ? 'marqueed' : 'marquee'">水钻</span>
            <span
