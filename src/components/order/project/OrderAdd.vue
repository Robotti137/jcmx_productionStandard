<template>
  <div>
    ...
    <el-dialog title="新增项目开工单" :visible.sync="orderAddDialogVisible" width="70%" append-to-body>
      <div class="container">
        <el-form label-width="210px" ref="orderForm">
          ...
          <el-form-item label-width="0">
            <el-checkbox-group v-model="productionType">
          ...
          <el-form-item>
            <el-checkbox-group v-model="buildingProduction.facade.type">
          ...
          <el-form-item>
            <el-checkbox-group v-model="buildingProduction.innerFacade.type">
          ...
          <el-form-item>
            <el-checkbox-group v-model="buildingProduction.businessFacade.type">
          ...
          <el-form-item label="园林风光：">
            <el-checkbox-group v-model="landscapeProduction.gardenScenery">
          ...
          <el-form-item>
            景观道路
            <br />
            <el-checkbox-group v-model="landscapeProduction.landscapeRoad.type">
          ...
          <el-form-item label="地形表现：">
            <el-checkbox-group v-model="landscapeProduction.terrainPerformance">
  ...
  data() {
    return {
      ...
      landscapeProduction: {
        ...
        crystalPerformanceLight: [], //水晶及其它表现方式灯光方式
        buildingBlock: {
          referenceMap: "",
          description: ""
        } //建筑体块
