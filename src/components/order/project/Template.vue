<template>
  <div class="container">
    ...
    <div class="flex border-b">
      ...
      <div style="width:54%;" class="height li-he border-l">&nbsp;&nbsp;{{order.projectName}}</div>
    ...
    <div class="flex border-b">
      ...
      <div style="width:19%;" class="border-l">
        <span class="i-b" style="margin-bottom:5px;word-break:break-all;">景观：{{order.projectSandTable.landscape}}</span>
        <span class="i-b" style="word-break:break-all;">建筑：{{order.projectSandTable.building}}</span>
      </div>
      ...
      <div style="width:19%;" class="border-l">
        <span class="i-b" style="margin-bottom:5px;word-break:break-all;">景观：{{order.other.landscape}}</span>
        <span class="i-b" style="word-break:break-all;">建筑：{{order.other.building}}</span>
      </div>
    </div>
    <div class="flex border-b">
      ...
      <div style="width:19%;" class="border-l">
        <div class="height border-b">
          ...
          >外尺寸：{{order.projectSandTable.externalDimensions}}</span>
        </div>
        <div class="height">
          <span
            class="i-b"
            style="word-break:break-all;"
          >内尺寸：{{order.projectSandTable.innerDimension}}</span>
        </div>
      </div>
      ...
      <div style="width:19%;" class="border-l">
        <div class="height border-b">
          <span class="i-b" style="word-break:break-all;">外尺寸：{{order.other.externalDimensions}}</span>
        </div>
        <div class="height">
          <span class="i-b" style="word-break:break-all;">内尺寸：{{order.other.innerDimension}}</span>
        </div>
      </div>
    </div>
    ...
    <div class="flex border-b">
      <div class="flex-j-i border-r" style="width:19%;">项目沙盘</div>
    ...
    <div class="flex border-b">
      ...
      <div class="flex-j-i" style="flex-wrap:wrap;flex:1;">
        ...
        <span :class="order.buildingProduction.abs === 'ABS3.0拼角' ? 'marqueed' : 'marquee'">ABS3.0拼角</span>
        <span :class="order.buildingProduction.abs === 'ABS4.0拼角' ? 'marqueed' : 'marquee'">ABS4.0拼角</span>
      </div>
    </div>
    <div class="flex border-b" style="min-height:200px;">
      <div
    ...
    <div class="flex border-b">
      <div class="flex-j-i border-r" style="width:19%;">水晶及其它表现方式灯光方式</div>
      <div class="center" style="flex:1;">
